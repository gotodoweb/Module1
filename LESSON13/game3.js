...
(() => {
	...
	const WORDS_ENG = ['you', 'computer', 'you win', 'you lost', 'draw', 'wrong value', 'More?', 'Are you sure you want to get out?'];
	const WORDS_RUS = ['вы', 'компьютер', 'вы выиграли', 'вы проиграли', 'ничья', 'неверное значение', 'Ещё?', 'точно ли вы хотите выйти?'];
